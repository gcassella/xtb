...
*--ptbdump*::
    ...
    matrices use tblite's spherical-harmonic component ordering (m = -l..+l),
    which differs from NWChem's; a consumer reading the basis through NWChem
    must reorder the matrices accordingly.
